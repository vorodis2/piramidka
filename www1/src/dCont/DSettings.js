...
///////////////////////////////////////////////////////////////////
            ...
            if (this.arrComp2[i].visible !== false) {
                ...
                if (bbwidth) {
                    ...
                    if(boolX==true){
                        ...
                        if((i+1)==this.arrComp2.length){
                            this.shagY = this.arrComp2[i-1].y + this.arrComp2[i-1].height + this.otstup;
                        }
        ...
        for (i = 0; i < this.object.arrComp.length; i++) {
            ...
            for (j = 0; j < this.arrComp.length; j++) {
                ...
                if (this.object.arrComp[i].name == this.arrComp[j].name) {
                   ...
                   // trace(i,j,"::",this.object.arrComp[i],this.arrComp[j])

                    if(this.object.arrComp[i]._param) if(this.object.arrComp[i]._param.e){
                        if(this.arrComp[j].setE)this.arrComp[j].setE(this.object.arrComp[i]._param.e)
                    }
    ...
    //////////////////////////////////////////////////////////
    this.getComponentFun=undefined
    ///////////////////////////////////
    ...
    this.addComponent = function (_type, _name, _param) {
        ...
        if(component==null){
            if(this.getComponentFun!=undefined){
                component=this.getComponentFun(_type, _param,this.content);
            }
        } 
        ...
        if (_param != undefined) {
            ...
            if (_param.e != undefined) if (component.setE!= undefined) component.setE(_param.e);
        }
