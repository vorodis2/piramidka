export default class PMTexture {
    ...
    updateTexture(objDin, reload) {
        trace("updateTexture",objDin, reload)
    ...
    getObj(id) {  
        ...
        for (var i = 0; i < this.param[this.nameType].length; i++) {
            ...
            if(id==this.param[this.nameType][i].id){
               
                let o
                if(typeof this.param[this.nameType][i].json === "string") {
                    o = JSON.parse(this.param[this.nameType][i].json)             
                } else o = this.param[this.nameType][i].json;

                this.param[this.nameType][i].obj=o
                

                return this.param[this.nameType][i]
            }
        }    
        return null//this.objbase.textures.find(o => o.id === id) || null;
    }
}
